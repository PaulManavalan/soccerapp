...
When `OLLAMA_MODEL=qwen2.5vl:7b`, Touchline automatically sends three 384px chronological frames. This is intentional: it leaves room for the roster and coaching prompt in Ollama's default local context while preserving before/during/after information for a short contest review.
